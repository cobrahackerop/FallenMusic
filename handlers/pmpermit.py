    ...
    if PMPERMIT == "ENABLE":
        if PMSET:
            ...
            await USER.send_message(
                message.chat.id,
                f"𝗛𝗘'𝗟𝗟 {message.from_user.mention()},\n𝓑𝓞𝓣 [{bn}](t.me/{lel})\n 𝐓𝐡𝐢𝐬 𝐈𝐬 𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥 𝐀𝐜𝐜𝐨𝐮𝐧𝐭 𝐃𝐨𝐧'𝐭📵 𝐓𝐫𝐲 𝐓𝐨 [𝐒𝐩𝐚𝐦] 𝐌𝐲 𝐌𝐚𝐬𝐭𝐞𝐫 𝐎𝐭𝐡𝐞𝐫𝐰𝐢𝐬𝐞 𝐘𝐨𝐮𝐫 𝐀𝐜𝐜𝐨𝐮𝐧𝐭 𝐁𝐚𝐧 𝐅𝐫𝐨𝐦 𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦 𝐌𝐲 𝐌𝐢𝐬𝐭𝐞𝐫 𝐒𝐞𝐧𝐝 𝐘𝐨𝐮𝐫 𝐒𝐦𝐬 𝐑𝐞𝐩𝐥𝐲 𝐓𝐡𝐞𝐧 𝐀𝐮𝐭𝐨 𝐈𝐦𝐩𝐫𝐨𝐯𝐞𝐝 𝐓𝐡𝐢𝐬 𝐩𝐫𝐨𝐜𝐞𝐬𝐬.. 𝓑𝔂 [🕊️⃝‌🦋𝐒 𝐑𝐚𝐣𝐩𝐮𝐭](t.me/{OWNER_USERNAME}).\n",
